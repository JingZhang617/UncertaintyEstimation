...
for epoch in range(1, (opt.epoch+1)):
    ...
    for i, pack in enumerate(train_loader, start=1):
        for rate in size_rates:
            ...
            loss_all1 = structure_loss(pred1, gts)
            loss_all2 = structure_loss(pred2, gts)
            loss_all3 = structure_loss(pred3, gts)
            # loss_all4 = structure_loss(pred4, gts)
            # loss_all5 = structure_loss(pred5, gts)
            # loss_all6 = structure_loss(pred6, gts)
            # loss_all7 = structure_loss(pred7, gts)
            # loss_all8 = structure_loss(pred8, gts)
            # loss_all9 = structure_loss(pred9, gts)
            # loss_all10 = structure_loss(pred10, gts)

            loss_all = loss_all1+loss_all2+loss_all3

            loss_all.backward()
            generator_optimizer.step()

            visualize_pred(torch.sigmoid(pred1))
            visualize_gt(gts)
