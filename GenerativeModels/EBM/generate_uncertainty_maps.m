...
img7_dir = ['./resultsM/' dataset '/' dataset '/sal6/'];
% img8_dir = ['./resultsM/' dataset '/' dataset '/sal7/'];
% img9_dir = ['./resultsM/' dataset '/' dataset '/sal8/'];
% img10_dir = ['./resultsM/' dataset '/' dataset '/sal9/'];
...
%     img10 = im2double(imread([img10_dir img_list(i).name]));
    mean = (img1+img2+img3+img4+img5+img6+img7)/7;
    predictive = compute_entropy(mean);
    aleatoric = (compute_entropy(img1)+compute_entropy(img2)+compute_entropy(img3)+compute_entropy(img4)+compute_entropy(img5)+compute_entropy(img6)+compute_entropy(img7))/7;
